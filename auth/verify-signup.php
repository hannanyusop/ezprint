...
require_once '../env.php';
    ...
    if(isset($_POST['register'])){
        ...
        if (!$db->query("INSERT INTO users (role_id, email, password, fullname, is_active, is_confirm, created_at) VALUES (3, '$_POST[email]', '$hash_pass', '$fullname', 1, 0, CURRENT_TIMESTAMP)")) {
            ...
            <p>This email has been registered to ezprint.my.<br>Temporary Password: $password<br><br>Please change this password to keep your account safe.
            ...
            sendEmail($_POST['email'], "Activate ezPrint Account", $body);
